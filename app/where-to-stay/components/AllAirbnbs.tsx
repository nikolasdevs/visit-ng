...
export default function AllAirbnbs() {
  const [allAirbnbs, setAllAirbnbs] = useState<Airbnb[]>([]);
  ...
  useEffect(() => {
    const fetchAllAirbnbs = async () => {
      try {
        ...
        setAllAirbnbs(response.data.data);
      } catch (error) {
